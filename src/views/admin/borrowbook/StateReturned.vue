<template>
    ...
    <div class="row g-0 pt-3 bg-white">
        ...
        <router-link :to="{ name: 'borrowedBorrows' }" class="col-2 text-center py-2 ">ĐANG
            MƯỢN</router-link>
        <router-link :to="{ name: 'returnedBorrows' }" class="col-2 text-center py-2 border-cus fw-bold">ĐÃ
            TRẢ</router-link>
            ...
            <div class="mt-3 col-md-5">
                <div v-if="activeBorrow">
                    ...
                    <div class="d-flex justify-content-around">
                        <button class="btn btn-danger text-white" @click="deleteBorrow(activeBorrow._id)">
...
export default {
    ...
    methods: {
        async deleteBorrow(id) {
            try {
                await borrowedborrowService.delete(id);
        ...
        async retrieveBorrows() {
            try {
                this.borrows = await borrowedborrowService.getByState('returned');
            } catch (error) {
                console.log(error);
            }
        },
